export default function BackgroundBlobs() {
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden z-0" aria-hidden="true">
      <div
        className="absolute -top-20 -left-20 w-[500px] h-[600px] opacity-15"
        style={{
      ...
      />
      <div
        className="absolute top-1/3 -left-16 w-[400px] h-[500px] opacity-10"
        style={{
      ...
      />
      <div
        className="absolute bottom-1/4 -left-24 w-[350px] h-[450px] opacity-10"
        style={{
      ...
      />
      <div
        className="absolute -top-16 -right-20 w-[450px] h-[550px] opacity-10"
        style={{
      ...
      />
      <div
        className="absolute top-1/2 -right-16 w-[380px] h-[480px] opacity-8"
        style={{
      ...
      />
      <div
        className="absolute bottom-20 -right-24 w-[320px] h-[420px] opacity-10"
        style={{
